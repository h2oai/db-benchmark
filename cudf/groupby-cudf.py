...
ans = x.groupby('id1', as_index=False, sort=False, dropna=False).agg({'v1':'sum'})
...
gc.collect()
t_start = timeit.default_timer()
ans = x.groupby(['id1','id2'], as_index=False, sort=False, dropna=False).agg({'v1':'sum'})
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
...
gc.collect()
t_start = timeit.default_timer()
ans = x.groupby('id3', as_index=False, sort=False, dropna=False).agg({'v1':'sum', 'v3':'mean'})
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
...
gc.collect()
t_start = timeit.default_timer()
ans = x.groupby('id4', as_index=False, sort=False, dropna=False).agg({'v1':'mean', 'v2':'mean', 'v3':'mean'})
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
...
gc.collect()
t_start = timeit.default_timer()
ans = x.groupby('id6', as_index=False, sort=False, dropna=False).agg({'v1':'sum', 'v2':'sum', 'v3':'sum'})
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
...
gc.collect()
t_start = timeit.default_timer()
ans = x.groupby(['id4','id5'], as_index=False, sort=False, dropna=False).agg({'v3': ['median','std']})
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
...
#gc.collect()
#t_start = timeit.default_timer()
#ans = x.groupby('id3', as_index=False, sort=False, dropna=False).agg({'v1':'max', 'v2':'min'}).assign(range_v1_v2=lambda x: x['v1']-x['v2'])[['range_v1_v2']]
#print(ans.shape, flush=True)
#t = timeit.default_timer() - t_start
#m = memory_usage()
#t_start = timeit.default_timer()
...
#gc.collect()
#t_start = timeit.default_timer()
#ans = x[~x['v3'].isna()][['id6','v3']].sort_values('v3', ascending=False).groupby('id6', as_index=False, sort=False, dropna=False).head(2)
#print(ans.shape, flush=True)
#t = timeit.default_timer() - t_start
#m = memory_usage()
#t_start = timeit.default_timer()
...
gc.collect()
t_start = timeit.default_timer()
ans = x.groupby(['id1','id2','id3','id4','id5','id6'], as_index=False, sort=False, dropna=False).agg({'v3':'sum', 'v1':'size'})
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
