...
dt = fread(csv.file, na.strings=c("","NA","NaN"), sep=",", colClasses=c(batch="integer", comment="character", version="character", git="character")) # file stores multiple batches of benchmark run, so the filtering below
