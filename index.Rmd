...
benchplot(1e7, timings=dt, code=groupby.code, colors=solution.colors)
```
![](groupby.1e7.png)
...
benchplot(1e8, timings=dt, code=groupby.code, colors=solution.colors)
```
![](groupby.1e8.png)
...
benchplot(1e9, timings=dt, code=groupby.code, colors=solution.colors)
```
![](groupby.1e9.png)
