...
benchplot(1e7, task="groupby", data=paste0("G1_",fn), timings=dt_task, code=groupby.code, exceptions=groupby.exceptions, colors=solution.colors, fnam=fnam, path=file.path("public",report_name,"plots"))
```
...
fnam = paste0("groupby.",fn,".png")
unlink(file.path("public",report_name,"plots", fnam))
benchplot(1e8, task="groupby", data=paste0("G1_",fn), timings=dt_task, code=groupby.code, exceptions=groupby.exceptions, colors=solution.colors, fnam=fnam, path=file.path("public",report_name,"plots"))
```
