...
groupby.data.exceptions = {list(                                                             # exceptions as of run 1575727624
  ...
  "cudf" = {list(
    "internal error: cudf#6828" = c("G1_1e7_1e2_0_0","G1_1e7_1e1_0_0","G1_1e7_2e0_0_0","G1_1e7_1e2_0_1","G1_1e7_1e2_5_0"), #217
...
join.query.exceptions = {list(
  ...
  "dask" =        list(),
  "juliadf" =     list(),
  "cudf" =        list("not yet implemented: cudf#8200" = c("J1_1e7_NA_0_0","J1_1e7_NA_5_0","J1_1e7_NA_0_1",
