...
- For a cuDF solution _on-disk_ memory actually means main memory because this is where memory spills from a GPU memory. Note as of the current moment only single GPU is used (11 GB), see [#148](https://github.com/h2oai/db-benchmark/issues/148) for more info
