...
Red dotted line refers to script timeout which initially was not set up. Later it was set on 60 minutes, more recently after adding new set of questions it was increased to 120 minutes. Up to date timeout value can be looked up in `timeout.csv` file.
