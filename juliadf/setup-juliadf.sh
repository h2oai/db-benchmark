...
# install julia
wget https://julialang-s3.julialang.org/bin/linux/x64/1.9/julia-1.9.0-rc2-linux-x86_64.tar.gz
tar -xvf julia-1.9.0-rc2-linux-x86_64.tar.gz
sudo mv julia-1.9.0-rc2 /opt
rm julia-1.9.0-rc2-linux-x86_64.tar.gz
# put to paths
echo 'export JULIA_HOME=/opt/julia-1.9.0-rc2' >> path.env
